            ...
            fprintf(stderr, "OK 3\n");
                ...
                if (sv->clipPlaneIdentificationMode){   // ### Drawing plane.  This actually works
                    ...
                    */
                    ...
                    // SUMA_PrepSO_GeomProp_GL(SO);

                    /*
                    SO->Group = strcpy(SO->Group, "Group");
                    SO->State = strcpy(SO->State, "spherical");
                    */
                    // SO->EmbedDim = 2;
...
/*
   ...
   case ButtonPress:
      ...
      pButton = Bev.button; // PDL: Has value 4 if scrollwheel scrolled forward and value 5 if scrollwheel scrolled back
